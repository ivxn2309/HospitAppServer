...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(multixsoft.hospitapp.management.DoctorManager.class        resources.add(multixsoft.hospitapp.management.PatientMapper.class);
        ...
        resources.add(multixsoft.hospitapp.webservice.AdminFacadeREST.class resources.add(multixsoft.hospitapp.webservice.AppointmentFacadeREST.class);
